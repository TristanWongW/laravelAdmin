...
@section('content')
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <form action="{{route('admin.admin.assignPermission',['id'=>$admin->id])}}" method="post" class="layui-form">
                {{csrf_field()}}
                {{method_field('put')}}
                ...
                <div class="layui-form-item">
                    ...
                    <a href="javascript:;" onclick="closeLayerIfram(0)" class="layui-btn" >返 回</a>
                </div>
