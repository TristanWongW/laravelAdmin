    ...
    <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
        <form action="<?php echo e(route('admin.login')); ?>" method="post">
            ...
            <div class="layui-form-item">
                ...
                <input type="text" name="name" value="<?php echo e(old('name')); ?>" lay-verify="required" placeholder="用户名" class="layui-input">
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-row">
                    ...
                    <div class="layui-col-xs5">
                        <div style="margin-left: 10px;">
                            <img src="<?php echo e(captcha_src()); ?>" onclick="this.src='<?php echo e(captcha_src()); ?>?t='+Math.random()" class="layadmin-user-login-codeimg" id="LAY-user-get-vercode">
                        </div>
                    </div>
                </div>
            </div>
