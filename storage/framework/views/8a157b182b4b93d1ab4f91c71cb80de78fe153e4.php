...
<head>
    <meta charset="utf-8">
    <title><?php echo e(isset($site['admin_title']) ? $site['admin_title'] : '后台管理'); ?></title>
    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:;">
                        <cite><?php echo e($admin->nickname); ?></cite>
                    </a>
                    <dl class="layui-nav-child">
                       
                        <dd><a lay-href="<?php echo e(route('admin.admin.password')); ?>">修改密码</a></dd>
                        <hr>
        ...
        <div class="layadmin-pagetabs" id="LAY_app_tabs">
            ...
            <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
                <ul class="layui-tab-title" id="LAY_app_tabsheader">
                    <li lay-id="<?php echo e(route('admin.index')); ?>" lay-attr="<?php echo e(route('admin.index')); ?>" class="layui-this"><i
