            ...
            layui.each(n, function (a, n) {
                ...
                var l = n.children && n.children.length > 0,
                    ...
                    s = o(["<li " + (n.spread ? 'data-spread="' + n.spread + '"' : "") + ">", function () {
                        ...
                        return i.check && i.check == "checkbox" ? '<input type="checkbox" lay-skin="primary" name="' + i.checkboxName + '" ' + ((n.checked && n.checked == true) ? 'checked="checked"' : "") + (n.checkboxValue ? ('value="' + n.checkboxValue + '"') : "") + 'data-parent-id="' + n.pid + '"' + 'id="' + n.id + '"' + (i.checkboxStyle ? ('style="' + i.checkboxStyle + '"') : "") + ' />' : "";
                    }(), function () {
